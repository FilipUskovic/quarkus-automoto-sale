...
public record CreateCarDTO(
        ...
        @Alphanumeric(message = "Brand can contain alphanumeric characters, spaces, hyphens, and underscores, and must be between 1 and 50 characters", min = 1, max = 50, allowSpecialCharacters = true)
        ...
        @NotEmpty(message = "Vin must not be empty")
